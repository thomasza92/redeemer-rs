...
fn spawn_hud(mut commands: Commands, assets: Res<AssetServer>) {
    ...
    commands
        .entity(hp_container)
        .add_children(&[hp_fill, hp_text_overlay]);
    commands
        .entity(hp_row)
        .add_children(&[hp_label, hp_container]);
    ...
    commands
        .entity(sp_container)
        .add_children(&[sp_fill, sp_text_overlay]);
    commands
        .entity(sp_row)
        .add_children(&[sp_label, sp_container]);
